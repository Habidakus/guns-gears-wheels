...
func _ready() -> void:
	...
	super._ready()
	#var center_hex_local_coords = _map_ground.map_to_local(center_hex_map_coords)
	#var x_plus_one_local_coords = _map_ground.map_to_local(center_hex_map_coords + Vector2i(1, 0))
	#print("X Dir = ", str(x_plus_one_local_coords - center_hex_local_coords))
	#var y_plus_one_local_coords = _map_ground.map_to_local(center_hex_map_coords + Vector2i(0, 1))
