...
{
    /// <summary>
    /// Base class that represents a game state for the <see cref="NegaMax.Calculator"/>
    /// 
    /// When using the <see cref="NegaMax.Calculator"/> you should create your own class that derives from this class
    ...
    public interface INMGameState
    {
        ...
        /// <see cref="NMScore.Reversed"/> would return the worth of the current game state from the point of view of the
        /// human opponent).
        /// </summary>
        NMScore Score { get; }
